...
const QUESTIONS = [
  {
    ...
    choices: [
      "The movie was <u>boring</u>. → 지루한",
      "The baby is taking a <u>nap</u>. → 낮잠",
      "Do you have your <u>own</u> room? → 소유하다",
      "Many <u>wild</u> animals are dying. → 야생의",
      "A turtle has a hard <u>shell</u>. → 껍질"
    ],
    answer: 2,
  ...
  },
  {
    ...
    choices: [
      "Look at <u>that</u> cute little puppy.",
      "I believe <u>that</u> we can make it.",
      "<u>That</u> he won the contest is amazing.",
      "Did you know <u>that</u> they were sisters?",
      "The important thing is <u>that</u> you did your best."
    ],
    answer: 0,
